...
/** 
 * @author xiaokang
 * @Description 对mybatis的操作进行重写，修改checkCandidate方法，只扫描结尾带mapper和dao的接口
 * @time 2016年5月26日 上午9:35:47 
 */
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner
{
	...
	{
		boolean flag=false;
		if (StringUtils.endsWithIgnoreCase(beanName, "Mapper"))
		{
			flag= true;
		}
		if (StringUtils.endsWithIgnoreCase(beanName, "Dao"))
		{
			flag= true;
		}
		if (!flag)
